...
yeccpars2_20(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 'yeccgoto_\'Step\''(hd(Ss), Cat, Ss, Stack, T, Ts, Tzr).
...
-file("src/xpath_parse.yrl", 324).
yeccpars2_36_(__Stack0) ->
 [__1 | __Stack] = __Stack0,
 [begin
   { has_namespace , value ( __1 ) }
  end | __Stack].

-compile({inline,yeccpars2_38_/1}).
-file("src/xpath_parse.yrl", 200).
...
-file("src/xpath_parse.yrl", 134).
yeccpars2_65_(__Stack0) ->
 [__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { step , attribute , __2 , __3 }
  end | __Stack].

-compile({inline,yeccpars2_66_/1}).
-file("src/xpath_parse.yrl", 179).
yeccpars2_66_(__Stack0) ->
 [__2,__1 | __Stack] = __Stack0,
 [begin
   [ { step , descendant , wildcard , [ ] } | __2 ]
  end | __Stack].

-compile({inline,yeccpars2_69_/1}).
-file("src/xpath_parse.yrl", 183).
yeccpars2_69_(__Stack0) ->
 [__3,__2,__1 | __Stack] = __Stack0,
 [begin
   __1 ++ [ { step , descendant , node , [ ] } | __3 ]
  end | __Stack].

-compile({inline,yeccpars2_70_/1}).
-file("src/xpath_parse.yrl", 123).
